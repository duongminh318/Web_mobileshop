...
<form action="update_nguoidung.php?idnd=<?php echo $idnd;?>" method="post" name="frm" onsubmit="return kiemtra()" enctype="multipart/form-data">
	<div class="dangky">
		...
		<label for="gioitinh">PHân Quyền</label>
		<select name="phanquyen" id="madm">
			<option value="0" > Quản Trị Viên </option>
			<option value="1" selected="selected"> Khách Hàng </option>
			<option value="2" selected="selected"> Nhân Viên Giao Hàng </option>
			<option value="3" selected="selected"> Nhân Viên Bán Hàng </option>
			<option value="4" selected="selected"> Nhân Viên Kho </option>
		</select>
